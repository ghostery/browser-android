...
public class GeckoPreferenceFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // remove Mozilla Fennec (About, Feedback, FAQ) & notifications screens
            ...
            removePreference(screen,PREFS_PRIVACY_TRACKING_PROTECTION);
            removePreference(screen,PREFS_PRIVACY_TRACKING_PROTECTION_LEARN_MORE);
        }
        /* Cliqz end */
    ...
    /* Cliqz start */
    // remove not needed preferences from FF
    private void removePreference(PreferenceScreen screen,String preferenceKey){
        final Preference preference = screen.findPreference(preferenceKey);
        if(preference != null) {
