...
/**
 * Derived from TwoLinePageRow.java
 */
public class TwoLinePageRowSuggestionItem extends ThemedLinearLayout
    ...
    public TwoLinePageRowSuggestionItem(Context context) {
        this(context, null);
    }

    public TwoLinePageRowSuggestionItem(Context context, AttributeSet attrs) {
        super(context, attrs);

        LayoutInflater.from(context).inflate(R.layout.two_line_page_row_suggestion_item, this);
    ...
    public void setPrivateMode(boolean isPrivate) {
        ...
        /* Cliqz Start */
        mStatusIcon.setPrivateMode(isPrivate);
        /* Cliqz End */
    }
