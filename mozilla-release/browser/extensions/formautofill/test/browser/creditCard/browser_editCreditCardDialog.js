...
add_task(async function test_saveCreditCard() {
  await testDialog(EDIT_CREDIT_CARD_DIALOG_URL, win => {
    ...
    EventUtils.synthesizeKey("VK_TAB", {}, win);
<<<<<<< HEAD:mozilla-release/browser/extensions/formautofill/test/browser/browser_editCreditCardDialog.js
...
>>>>>>> upstream-releases:mozilla-release/browser/extensions/formautofill/test/browser/creditCard/browser_editCreditCardDialog.js
    EventUtils.synthesizeKey("VK_TAB", {}, win);
