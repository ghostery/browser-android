...
foo = Foo 1
""")
<<<<<<< HEAD:mozilla-release/third_party/python/compare-locales/compare_locales/tests/test_merge_ftl.py
...
""")
=======
>>>>>>> upstream-releases:mozilla-release/third_party/python/compare-locales/compare_locales/tests/fluent/test_merge.py
