...
<<<<<<< HEAD:mozilla-release/third_party/python/compare-locales/compare_locales/tests/test_checks.py
...
=======
>>>>>>> upstream-releases:mozilla-release/third_party/python/compare-locales/compare_locales/tests/dtd/test_checks.py
